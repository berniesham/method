...
Our evaluation system determines the electricity consumption within the following scope:

### - **[Creative delivery (ad distribution)](https://impact.mintlify.app/creativedelivery)**
### - **[Supply path (allocation of advertising space)](https://impact.mintlify.app/supplypath.mdx)**
